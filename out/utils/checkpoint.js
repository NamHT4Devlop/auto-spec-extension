...
async function askComment(label) {
    const choice = await vscode.window.showQuickPick(['💬 Yes — I want to add feedback', '⏭  No — Skip and continue'], { title: `Review Checkpoint: ${label}`, placeHolder: 'Do you want to add a comment?' });
